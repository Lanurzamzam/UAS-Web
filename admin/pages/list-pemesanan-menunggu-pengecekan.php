            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Pemesanan Menunggu Pengecekan</h3>  
                </div><!-- /.box-header -->
                <div class="box-body">
                     ...
                     ?>
                      <tr>
                        ...
                        <td><?php echo $q['kd_pesan']; ?></td>
                         ...
                         <td>
                          <a href="./pages/konfirmasi-pemesanan.php?id=<?php echo $q['kd_pesan']; ?>" onclick="return confirm('Anda yakin ingin mengkonfirmasi pemesanan ini.?')" class="btn btn-warning"><i class="fa fa-check"></i> Lunas</a>
                        </td>
                      </tr>
