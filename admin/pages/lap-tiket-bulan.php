            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Tiket Bulanan</h3>  
                </div><!-- /.box-header -->
                    <div class="box-header">
                    <div class="row">
                      <div class="col-md-12">
                      <form action="#" method="post">
                        ...
                        <div class="col-md-4">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="bulan" value="<?php if(empty($_POST['bulan'])){echo "";}else{echo $_POST['bulan'];} ?>" placeholder="Bulan" id="datepicker1">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="tahun" value="<?php if(empty($_POST['tahun'])){echo "";}else{echo $_POST['tahun'];} ?>" placeholder="Tahun" id="datepicker2">
                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-1"><button type="submit" name="b1" class="btn btn-info"><i class="fa fa-search"></i> Cari</button>
                           ...
                           <div class="col-md-1"><a href="./pages/cetak-tiket-bulan.php?bulan=<?php echo $_POST['bulan']; ?>&tahun=<?php echo $_POST['tahun']; ?>" target="_blank" class="btn btn-warning"><i class="fa fa-print"></i> Cetak</a>
                          </div>
