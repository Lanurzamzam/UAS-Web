...
<body onload="window.print();">
    ...
    <h4><b>LAPORAN PEMESANAN TIKET HARIAN</b></h4>
 ...
 <center>Tanggal : <b><?php if(!empty($_GET['tanggal'])){ echo date('d F Y',strtotime($_GET['tanggal'])); }else{ echo "Semua Tanggal"; } ?></b></center>
 <br>
  </div>
