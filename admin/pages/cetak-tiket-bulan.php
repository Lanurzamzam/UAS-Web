...
<body onload="window.print();">
    ...
    <h4><b>LAPORAN PEMESANAN TIKET BULANAN</b></h4>
 ...
 <center>BULAN : <b><?php echo $_GET['bulan']."-".$_GET['tahun']; ?></b></center>
 <br>
  </div>
